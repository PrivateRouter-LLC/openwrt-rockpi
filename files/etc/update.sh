...
[ is_connected ] && {
   ...
   opkg install jq git-http bash kmod-mwifiex-pcie kmod-mwifiex-sdio kmod-rtl8723bs kmod-rtlwifi kmod-rtlwifi-btcoexist kmod-rtlwifi-pci kmod-rtlwifi-usb kmod-wil6210 libuwifi
   ...
   opkg install procd-ujail python3-base python3-email python3-light python3-logging python3-openssl python3-pysocks python3-urllib resolveip rpcd rpcd-mod-file rpcd-mod-iwinfo rpcd-mod-luci luci-mod-dashboard luci-app-commands

   opkg install rpcd-mod-rpcsys rpcd-mod-rrdns rsync samba4-libs samba4-server nano sshfs terminfo tor ubi-utils kmod-usb-net-asix-ax88179 luci-mod-dashboard luci-app-commands  rpcd-mod-luci luci-app-statistics
