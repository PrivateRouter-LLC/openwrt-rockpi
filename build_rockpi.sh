...
make image PROFILE="radxa_rock-pi-4" \
           PACKAGES="bash kmod-rt2800-usb rt2800-usb-firmware kmod-cfg80211 kmod-lib80211 kmod-mac80211 kmod-rtl8192cu \
                     ...
                     zlib firewall iptables wireless-regdb f2fsck openssh-sftp-server \
                     kmod-usb-wdm kmod-usb-net-ipheth usbmuxd kmod-veth uxc \
